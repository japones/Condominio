...
public class Usuario  implements java.io.Serializable {
    ...
    public Usuario(String nome, String usuario, String senha, int usuarioinclusao, Date datainclusao) {
        this.nome = nome;
    ...
    public Usuario(String nome, String usuario, String senha, int usuarioinclusao, Date datainclusao, Integer usuarioalteracao, Date dataalteracao) {
       this.nome = nome;
       this.usuario = usuario;
       this.senha = senha;
       this.usuarioinclusao = usuarioinclusao;
